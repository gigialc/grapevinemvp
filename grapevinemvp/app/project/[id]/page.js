    ...
    <div className="min-h-screen bg-gray-100 relative">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-4 flex items-center">
          {project.title}
          <a href={`/live`} className="ml-2 bg-red-500 rounded-full w-6 h-6 flex items-center justify-center shadow-lg hover:shadow-xl hover:bg-red-600 transition duration-300 ring-2 ring-black">
          </a>
        </h1>
